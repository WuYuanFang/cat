...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    XQZQSearchModel *model = self.datas[indexPath.row];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[ZQSearchEditNormalCell class] forCellReuseIdentifier:[ZQSearchEditBaseCell childCellIdentifierWith:@(SearchEditTypeFuzzy)]];
        [_tableView registerClass:[ZQSearchConfirmCell class] forCellReuseIdentifier:[ZQSearchEditBaseCell childCellIdentifierWith:@(SearchEditTypeConfirm)]];
    }
    return _tableView;
}
